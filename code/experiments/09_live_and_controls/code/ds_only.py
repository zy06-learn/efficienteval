...
OUT = ROOT/"experiments"/"runs"/"dataset_control_v1"; OUT.mkdir(parents=True, exist_ok=True)
...
CHEAP = json.loads((ROOT/"experiments"/"cross_stage_contract"/"part1c_main_full_v1"/"00_contract"/
