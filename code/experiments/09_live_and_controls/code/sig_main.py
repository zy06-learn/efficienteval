...
R = Path(os.environ.get("AFR_ROOT", _AFR_DEFAULT) + "/experiments/cross_stage_contract/"
         "part1c_main_full_v1/10_row_level")
OUT = Path(os.environ.get("AFR_ROOT", _AFR_DEFAULT) + "/experiments/runs/sig_main_v1")
