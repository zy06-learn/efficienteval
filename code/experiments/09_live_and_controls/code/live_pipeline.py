...
sys.path.insert(0, str(ROOT)); sys.path.insert(0, str(ROOT / "ingest_and_scoring"))
sys.path.insert(0, str(ROOT / "experiments"))
sys.path.insert(0, str(ROOT / "experiments" / "experiments" / "08_routing_code"))
...
HP     = json.loads((ROOT / "experiments" / "cross_stage_contract" / "part1c_main_full_v1" /
...
FEATURES = json.loads((ROOT / "experiments" / "cross_stage_contract" / "part1c_main_full_v1" /
