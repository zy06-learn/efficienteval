...
LIVE_OUT=$AFR_ROOT/experiments/runs/live_main_v1 LIVE_STAGE=plan   python code/live_main.py
LIVE_OUT=$AFR_ROOT/experiments/runs/live_main_v1 LIVE_STAGE=local  python code/live_main.py
#   start vLLM with the flags in 06_verifier_registry, then:
LIVE_OUT=$AFR_ROOT/experiments/runs/live_main_v1 LIVE_STAGE=api    python code/live_main.py
LIVE_OUT=$AFR_ROOT/experiments/runs/live_main_v1 LIVE_STAGE=finish python code/live_main.py
# 2-4 are CPU only
