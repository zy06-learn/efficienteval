...
# This file lives in ingest_and_scoring, so its own directory is the default. AFR_ROOT overrides it
# for callers that run the stage from somewhere else.
V2 = Path(os.environ["AFR_ROOT"]) / "ingest_and_scoring" if os.environ.get("AFR_ROOT") \
