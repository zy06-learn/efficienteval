...
for p in (ROOT, ROOT / "paper_v2", ROOT / "paper_v3",
          ROOT / "paper_v3" / "DELIVERABLE" / "08_scripts",
          ROOT / "paper_v3" / "DELIVERABLE" / "09_live_and_controls" / "code"):
    sys.path.insert(0, str(p))

OUT = Path(os.environ["SIG_OUT"])
OUT.mkdir(parents=True, exist_ok=True)
os.environ.setdefault("V3_RUN_DIR", str(OUT))
LIVE_DIR = Path(os.environ.get("LIVE_DIR", ROOT / "paper_v3" / "runs" / "live_main_v1"))
